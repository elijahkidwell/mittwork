...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Book boxing, MMA, BJJ, wrestling, and strength trainers near you.",
      },
    ...
    links: [
      ...
      { rel: "apple-touch-icon", href: "/__grok/icon-180.png", sizes: "180x180" },
